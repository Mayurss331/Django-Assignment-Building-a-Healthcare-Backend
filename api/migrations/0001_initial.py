# Generated by Django 4.2.17 on 2025-06-12 09:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patients', to='api.user')),
            ],
            options={
                'ordering': ['name'],
            },
